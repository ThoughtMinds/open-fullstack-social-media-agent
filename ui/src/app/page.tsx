...
//       <div className="flex-none w-[220px] min-w-auto border-r border-gray-200 bg-white shadow-md h-full">
//         <SideBar />
//       </div>

//       {/* MainContent - 3/5 of the width */}
//       <div className="flex-grow w-3/5 min-w-[300px] border-r border-gray-200 bg-white p-4 pl-7 overflow-y-auto h-full">
//         <MainContent />
//       </div>

//       {/* CopilotChat - 1/5 of the width */}
//       <div className="flex-none w-[350px] min-w-[200px] bg-gray-50 h-full">
//         <CopilotChat
